...
For the module's final project I had to code an E-Commerce Page based on an example that was given using HTML, CSS and JavaScript. I decided to change the theme from a clothing store to a pet supplies store. The product list and shopping cart were created using DOM. You can add and remove items to and from the cart, you can filter items by category using the buttons at the top of the page and you can search items by their name using the search bar.<br />
<br />
